...
const SUBJECTS = [
  { value: "adld", label: "Advanced Digital Logic Design (ADLD)" },
...
export default function TeacherAuthPage() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      const data = await authApi.teacherLogin(loginEmail, loginPassword);
  ...
  const handleRegister = async (e: React.FormEvent) => {
    ...
    try {
      const data = await authApi.teacherRegister(
        registerEmail,
        registerPassword,
        registerSubject,
      );
              ...
              <form onSubmit={handleRegister} className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <select
                    ...
                    required
                    className="w-full h-12 px-3 bg-background border border-border rounded-md text-foreground focus:outline-none focus:border-primary focus:ring-2 focus:ring-primary/10 cursor-pointer"
                  >
